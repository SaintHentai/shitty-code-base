...
public class MinimumDistances {
    ...
    static int minimumDistances(List<Integer> arr){
        int result;
        int tail = arr.size() - 1;
        if (arr.size() > 1){
